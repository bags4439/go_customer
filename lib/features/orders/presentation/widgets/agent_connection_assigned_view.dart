...
class AgentConnectionAssignedView extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              const AgentConnectionNextStep(
                number: 2,
                text: 'Your agent sends vehicle options '
                    'with full cost breakdowns in chat',
              ),
              const AgentConnectionNextStep(
                number: 3,
                text: 'No payment until your agent sends '
                    'a payment request',
                isLast: true,
              ),
            ],
